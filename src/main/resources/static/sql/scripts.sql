...
-- Agregar perfil de REPRESENTANTE
INSERT INTO `maxigestion_db`.`perfiles` (`nombre_perfil`, `roles_id_rol`) VALUES ('REPRESENTANTE', (SELECT id_rol FROM roles WHERE nombre_rol = "ADMINISTRADOR"));
